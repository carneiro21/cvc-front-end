...
export const AJUDAS: Ajuda[] = [
  {
    codigo: 1,
    titulo: 'CRUD de Usuário',
    conteudo: 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos ' +
    ...
    urlVoltar: '/main/app-exemplo/usuario'
  }
];
